...
## ‼️ Working on remaking my old programming projects atm and then uploading them on github

1. Self-Discord Bot with Character AI
    - Context Aware
...
- I use [Tailwind.css](https://tailwindcss.com/) with [Next.JS](https://nextjs.org/)
- I also use [Bootstrap](https://getbootstrap.com/)
- I have experience with *vanilla* [NodeJS](https://nodejs.org) too
